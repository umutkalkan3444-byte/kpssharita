...
export const Route = createFileRoute("/istatistik")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Seviyeni, serini, kategori başarılarını ve rozetlerini görüntüle.",
      },
    ],
  }),
  component: StatsPage,
...
function Kpi({
  ...
  return (
    <div className="rounded-3xl border border-cyan-200 bg-white/80 p-4 shadow-sm backdrop-blur">
      <div
        className={`inline-grid h-8 w-8 place-items-center rounded-xl bg-gradient-to-br ${accent} text-white`}
      >
        {icon}
      </div>
